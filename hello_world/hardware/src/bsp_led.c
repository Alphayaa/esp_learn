...
void led_init(void)
{
    ...
    // while (1) {
        ...
        // }
        led_indicator_start(led_handle, BLINK_SLOW);
        // vTaskDelay(4000 / portTICK_PERIOD_MS);
        // led_indicator_stop(led_handle, BLINK_SLOW);
        // led_on();
    // }
#endif
}
...
void led_on(void)
{
    led_indicator_gpio_set_on_off(led_handle, 0);
}

void led_off(void)
{
    led_indicator_gpio_set_on_off(led_handle, 1);
}